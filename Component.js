...
jQuery.sap.declare("Z_HR_CONTACT.Component");
jQuery.sap.require("sap.ui.core.UIComponent");
jQuery.sap.require("sap.ui.core.routing.History");
jQuery.sap.require("sap.m.routing.RouteMatchedHandler");

sap.ui.core.UIComponent.extend("Z_HR_CONTACT.Component", {
	metadata: {
		"name": "Z_HR_CONTACT",
		"version": "1.1.0",
		"library": "Z_HR_CONTACT",
		...
		"config": {
			...
			serviceConfig: {
				...
				serviceUrl: "/sap/opu/odata/sap/ZCONTACTS_SRV/"
			}
		},
		routing: {
	...
	createContent: function() {
		...
		return sap.ui.view({
			viewName: "Z_HR_CONTACT.view.App",
	...
	init: function() {
		...
		jQuery.sap.require("Z_HR_CONTACT.util.formatter");

		// always use absolute paths relative to our own component
		// (relative paths will fail if running in the Fiori Launchpad)
		var sRootPath = jQuery.sap.getModulePath("Z_HR_CONTACT");
	...
	_initODataModel: function(sServiceUrl) {
		jQuery.sap.require("Z_HR_CONTACT.util.messages");
		var oConfig = {
			metadataUrlParams: {},
			json: true,
		...
		oModel.attachRequestFailed(null, Z_HR_CONTACT.util.messages.showErrorMessage);
